...
class TestAPI:
    ...
    @patch("api_intelligence_mcp.src.api.settings")
    ...
    def test_app_imports(self):
        ...
        import api_intelligence_mcp.src.api

        assert api_intelligence_mcp.src.api.app is not None

    def test_server_initialization(self):
        """Test that the server is properly initialized."""
        # Arrange & Act
        from api_intelligence_mcp.src.api import server
    ...
    def test_transport_protocol_configuration(self, mock_settings):
        ...
        import api_intelligence_mcp.src.api as api_module
