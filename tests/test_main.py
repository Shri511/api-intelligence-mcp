...
from api_intelligence_mcp.src.main import (
...
class TestValidateConfig:
    ...
    @patch("api_intelligence_mcp.src.main.validate_config_func")
    @patch("api_intelligence_mcp.src.main.logger")
...
class TestHandleStartupError:
    ...
    @patch("api_intelligence_mcp.src.main.logger")
    @patch("api_intelligence_mcp.src.main.sys")
...
class TestMain:
    ...
    @patch("api_intelligence_mcp.src.main.validate_config")
    @patch("api_intelligence_mcp.src.main.logger")
    @patch("api_intelligence_mcp.src.main.uvicorn")
    def test_main_success(self, mock_uvicorn, mock_logger, mock_validate):
        ...
        with patch("api_intelligence_mcp.src.main.settings", mock_settings):
            # Act
            main()
    ...
    @patch("api_intelligence_mcp.src.main.run")
    @patch("api_intelligence_mcp.src.main.logger")
    @patch("api_intelligence_mcp.src.main.sys")
    ...
    @patch("api_intelligence_mcp.src.main.validate_config")
    @patch("api_intelligence_mcp.src.main.handle_startup_error")
...
class TestRun:
    ...
    @patch("api_intelligence_mcp.src.main.main")
    @patch("api_intelligence_mcp.src.main.logger")
    @patch("api_intelligence_mcp.src.main.sys")
