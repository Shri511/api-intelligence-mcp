...
from api_intelligence_mcp.utils.pylogger import (
    AWS_LOGGERS,
    ERROR_ONLY_LOGGERS,
    HTTP_CLIENT_LOGGERS,
    MCP_LOGGERS,
...
class TestPylogger:
    ...
    @patch("api_intelligence_mcp.utils.pylogger.structlog")
    @patch("api_intelligence_mcp.utils.pylogger._LOGGING_CONFIGURED", False)
    def test_get_python_logger_structlog_configuration(self, mock_structlog):
        ...
        # Act
        with patch("api_intelligence_mcp.utils.pylogger._LOGGING_CONFIGURED", False):
            get_python_logger()
    ...
    def test_get_python_logger_import(self):
        ...
        # Act & Assert
        try:
            import api_intelligence_mcp.utils.pylogger

            assert api_intelligence_mcp.utils.pylogger.get_python_logger is not None
        except ImportError as e:
            pytest.fail(f"Module should be importable: {e}")

    # Tests for force_reconfigure_all_loggers()
    @patch("api_intelligence_mcp.utils.pylogger.get_python_logger")
    ...
    @patch("api_intelligence_mcp.utils.pylogger._LOGGING_CONFIGURED", True)
    @patch("api_intelligence_mcp.utils.pylogger.get_python_logger")
    def test_force_reconfigure_resets_global_flag(self, mock_get_logger):
        ...
        import api_intelligence_mcp.utils.pylogger as pylogger_module
    ...
    @patch("api_intelligence_mcp.utils.pylogger.logging")
    @patch("api_intelligence_mcp.utils.pylogger._clear_handlers")
    ...
    @patch("api_intelligence_mcp.utils.pylogger.logging")
    @patch("api_intelligence_mcp.utils.pylogger._setup_logger")
