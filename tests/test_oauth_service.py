...
from api_intelligence_mcp.src.oauth.service import (
    add_token_to_code,
    base64url_encode,
    cleanup_storage,
...
class TestUtilityFunctions:
    ...
    def test_verify_code_challenge_error_handling(self):
        ...
        with patch(
            "api_intelligence_mcp.src.oauth.service.hashlib.sha256"
        ) as mock_sha256:
...
class TestStorageService:
    ...
    async def test_get_storage_service_not_initialized(self):
        ...
        with patch("api_intelligence_mcp.src.oauth.service._storage_service", None):
    ...
    async def test_get_storage_service_initialized(self):
        ...
        mock_storage = Mock()
        with patch(
            "api_intelligence_mcp.src.oauth.service._storage_service", mock_storage
        ):
    ...
    async def test_initialize_storage_success(self):
        ...
        with patch(
            "api_intelligence_mcp.src.oauth.service.StorageService"
        ) as mock_storage_class:
            mock_storage_class.return_value = mock_storage
            with patch(
                "api_intelligence_mcp.src.oauth.service.settings"
            ) as mock_settings:
...
class TestClientManagement:
    ...
    async def test_validate_client_success(self):
        ...
        with patch(
            "api_intelligence_mcp.src.oauth.service.get_storage_service",
    ...
    async def test_register_client_new(self):
        ...
        with patch(
            ...
            with patch(
                "api_intelligence_mcp.src.oauth.service.generate_random_string"
            ) as mock_gen:
...
class TestOAuthServiceEdgeCases:
    ...
    async def test_validate_authorization_code_expired(self):
        ...
        from api_intelligence_mcp.src.oauth.service import OAuthService
        from api_intelligence_mcp.src.storage.storage_service import StorageService
